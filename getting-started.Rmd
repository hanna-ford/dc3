...
5.  Download the RBioTools tar.gz from here: <https://github.com/hanna-ford/dc3/blob/main/docs/RBiotools_0.5.0.tar.gz>

    -   Save this tar.gz file in the root of your Working Directory

6.  Download the `getting-started.R` script from here:
<https://raw.githubusercontent.com/hanna-ford/dc3/main/docs/getting-started.R>
...
```{r install.packages, eval=FALSE, echo=TRUE, error=FALSE, warning=FALSE, message=FALSE}
  ...
  install.packages("RBiotools_0.5.2.tar.gz", repos = NULL, type = "source")
