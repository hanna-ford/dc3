...
![](./r_repository/dendrogram-1.png)

```{r dendrogram.pb, eval = TRUE, echo = TRUE, fig.width=6, fig.height=6, fig.align = 'center'}
  #The second plot is for the proteobacteria organisms
  dendrogram16S(proteobacteria)

```

![](./r_repository/dendrogram-2.png)
