...
5.  Setup the working directory
  ...
  *Setting the working directory:* the location of your working directory is up to you; however, make sure to change the code below, as needed. For these instructions we have placed the BMIG5101 folder in our Temp directory.
...
![](./r_repository/orgdata-details.png)
